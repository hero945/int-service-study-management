ALTER TABLE hd_plt_study ADD COLUMN team_version BIGINT NOT NULL DEFAULT 0;
...
CREATE TABLE hd_plt_team_role (
    ...
    function_line_id BIGINT,
    is_project_lead SMALLINT NOT NULL DEFAULT 0,
    can_manage_team SMALLINT NOT NULL DEFAULT 0,
    sort_order INT NOT NULL DEFAULT 0,
    status_code VARCHAR(20) NOT NULL DEFAULT 'ACTIVE',
    sys_create_by VARCHAR(254) NOT NULL,
    sys_update_by VARCHAR(254) NOT NULL,
...
ALTER TABLE hd_plt_team_assignment ADD COLUMN function_line_id BIGINT;
ALTER TABLE hd_plt_team_assignment ADD COLUMN function_line_code_snapshot VARCHAR(64);
ALTER TABLE hd_plt_team_assignment ADD COLUMN function_line_name_snapshot VARCHAR(100);
ALTER TABLE hd_plt_team_assignment ADD CONSTRAINT uk_hd_plt_team_assignment
    UNIQUE(study_id, team_role_id, user_id);
