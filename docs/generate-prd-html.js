...
<div class="layout"><aside class="sidebar"><div class="sidebar-label">DOCUMENT OUTLINE</div><nav class="toc" aria-label="文档目录">${tocHtml}</nav></aside><main class="document"><article class="paper"><header class="hero"><div class="hero-kicker">Clinical R&amp;D Pipeline Management</div><h1>${escapeHtml(title)}</h1><div class="hero-meta"><span>版本 v1.0</span><span>页面功能与字段逻辑</span><span>权限与验收标准</span><span>离线可打开</span></div></header><section class="content">${output.join('\n')}</section></article></main></div>
